        ...
        <div class="col-sm-12 col-xs-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('manager.event.add') }}" class="btn btn-success btn-sm">ADD NEW</a>
                    <div class="col-sm-3">
                        <form id="location-form" action="{{ route('manager.event.post.index') }}" method="post">
                            {{ csrf_field() }}
                    ...
                    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('manager.event.delete') }}" method="post">
